...
inline bool withinValidInputRange(::ad::rss::situation::SituationVector const &input, bool const logErrors = true)
{
  ...
  {
    spdlog::error("withinValidInputRange(::ad::rss::situation::SituationVector)>> {}, invalid input range", input);
  }
  ...
  if (inValidInputRange)
  {
    for (auto const &member : input)
    {
      ...
      {
        spdlog::error(
          "withinValidInputRange(::ad::rss::situation::SituationVector)>> {}, invalid member {}", input, member);
      }
    }
  }
