 ...
 */
template <> struct fmt::formatter<::ad::rss::world::OccupiedRegionVector> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::rss::world::OccupiedRegionVector const &value, FormatContext &ctx)
  {
