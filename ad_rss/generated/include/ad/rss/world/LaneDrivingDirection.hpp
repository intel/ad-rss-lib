 ...
 */
template <> struct fmt::formatter<::ad::rss::world::LaneDrivingDirection> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::rss::world::LaneDrivingDirection const &value, FormatContext &ctx)
  {
