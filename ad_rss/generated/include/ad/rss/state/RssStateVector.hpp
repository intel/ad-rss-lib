 ...
 */
template <> struct fmt::formatter<::ad::rss::state::RssStateVector> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::rss::state::RssStateVector const &value, FormatContext &ctx)
  {
