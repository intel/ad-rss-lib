 ...
 */
template <> struct fmt::formatter<::ad::rss::state::LongitudinalResponse> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::rss::state::LongitudinalResponse const &value, FormatContext &ctx)
  {
