 ...
 * @param[in]  max_speed_on_acceleration is the maximum speed of the vehicle (e.g. restricted by a limit) to be
 * considered
 ...
 * @param[in]  max_speed_on_acceleration is the maximum speed of the vehicle (has to be always positive) to be
 * considered
 * while accelerating
 * @param[in]  response_time          the time after which \a aAfterResponseTime is used instead of
 ...
 * @param[in] response_time          the time after which \a aAfterResponseTime is used instead of
 *                                  \a aUntilResponseTime as acceleration
 * @param[in] max_speed_on_acceleration is the maximum speed of the vehicle (has to be always positive) to be considered
 * while accelerating
