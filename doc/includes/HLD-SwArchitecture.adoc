...
For a detailed explanation of the individual types, please have a look into the doxygen documentation (https://intel.github.io/ad-rss-lib/doxygen/html/index.html).

===== Namespace ad::rss::physics
